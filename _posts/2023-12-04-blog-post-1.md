...
![](images/blog_post/imagnet_all.png ){width="30%"}
...
![gradient saturation](images/blog_post/1701417373872.png "Image by Krishnaram Kenthapadi ([Explainable AI in Industry](https://www.slideshare.net/KrishnaramKenthapadi/explainable-ai-in-industry-kdd-2019-tutorial) (KDD 2019 Tutorial))"){width="50%"}
...
![1701588009617](images/blog_post/1701588009617.png)
...
![1701588009617](images/blog_post/gradpath.png){width="50%"}
...
![1701588009617](images/blog_post/gradpath_Doberman.png){width="50%"}
...
![1701588009617](images/blog_post/mnist_example.png){width="50%"}
<center>Feature attributions of MNIST samples. (a) Shifted digital 1s explained with the references of digitals 7. (b) Digitals 5 explained with the references of different categories (digitals 3, 6, 9). The most critical areas that distinguish the explicand to reference are marked by red boxes, e.g., the explained digitals 1 will become digital 7 if we filled these areas. IG2 is compared with vanilla IG (using black baseline) and Expected IG (using references as the baselines). </center>
...
IG<sup>2</sup> combines two advantages of Guided IG and expected IG, perspectively attributed to two techniques, GradPath and GradCF:
...
![](images/blog_post/TREC_explain_No_long.png ){width="80%"}
...
![](images/blog_post/celebA_res.png ){width="80%"}
...
![](images/blog_post/Wafer_comparison.png ){width="80%"}
