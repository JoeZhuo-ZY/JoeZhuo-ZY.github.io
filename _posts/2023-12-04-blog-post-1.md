...
<p style="color: blue; font-size: 3px; text-align: center;">Summary of existing path methods from the aspects of path and baseline.</p>
...
Image by Krishnaram Kenthapadi ([Explainable AI in Industry](https://www.slideshare.net/KrishnaramKenthapadi/explainable-ai-in-industry-kdd-2019-tutorial) (KDD 2019 Tutorial))
